...
export const ru: TranslationKeys = {
  ...
  loadedCount: (count: number) => `Загружены: ${count}`,
  evidence: "Источник",
  validation: "Проверка",
  approveReadyRows: "Подтвердить готовые строки",
  approveRow: "Подтвердить строку",
  commitImport: "Загрузить в базу",
  loadApprovedRows: "Загрузить подтверждённые строки",
  loadingApprovedRows: "Загрузка подтверждённых строк...",
  committing: "Загрузка...",
  ...
  importDocumentStatusReady: "Готов к загрузке",
  importDocumentStatusNeedsReview: "Требует проверки",
  importDocumentStatusProcessing: "Обработка",
  importDocumentStatusFailed: "Ошибка",
  importDocumentCounts: (total: number, approved: number, loaded: number) =>
    `Загружено ${loaded}/${total} · подтверждено ${approved}`,
  noImportDocuments: "Документов импорта пока нет",
  importDocumentResumed: "Открыт существующий документ импорта для этого файла.",
  operationImportCandidateStatus: (status: string) => {
  ...
  historicalBalancesExplanation:
    "Остатки на дату рассчитываются по подтвержденным операциям. Поздние исправления могут изменить результат за прошлую дату.",
  ...
  ozonConnectedMessage: "Доступ к Ozon сохранён; начальная синхронизация поставлена в очередь.",
  ...
  ozonDataSyncedThrough: "Данные синхронизированы по",
  ozonNextAutomaticSync: "Следующая автоматическая синхронизация",
  ozonSyncInProgress: "Синхронизация Ozon выполняется. Это может занять минуту.",
  ozonSyncStatusRunning: "Выполняется",
  ozonSyncStatusRetrying: "Автоматическая повторная попытка",
  ...
  ozonSyncExecutionCount: "Запуски (включая продолжения)",
  ozonSyncFailureCount: "Ошибки (текущий цикл повторов)",
